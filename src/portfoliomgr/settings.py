...
env_file_exist = os.path.exists("C:/Users/rajsa/Documents/portfoliomanager-main (1)/portfoliomanager-main/env_files/.pm-env")

if env_file_exist:
    environ.Env.read_env("C:/Users/rajsa/Documents/portfoliomanager-main (1)/portfoliomanager-main/env_files/.pm-env")

else:
    raise Exception(f'Environment file was not found in {"C:/Users/rajsa/Documents/portfoliomanager-main (1)/portfoliomanager-main/env_files/.pm-env"}')
...
if DB_ENGINE == 'sqlite3':
    ...
    raise Exception(f'Unsupported database engine. Check DB_ENGINE parameter in {"C:/Users/rajsa/Documents/portfoliomanager-main (1)/portfoliomanager-main/env_files/.pm-env"}.')
...
if DB_ENGINE == 'sqlite3':
    ...
    raise Exception(f'Unsupported Huey configuration. Check DB_ENGINE parameter in {"C:/Users/rajsa/Documents/portfoliomanager-main (1)/portfoliomanager-main/env_files/.pm-env"}.')
